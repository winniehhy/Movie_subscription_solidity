...
contract TransactionPayment {
    address payable public constant BENEFICIARY_ADDRESS = payable(0xEBf3DD4Fb5466791f924140aAA3D5b9387E4A19E); // Correct beneficiary address
    ...
    function executeSubscription(bytes32 _subscriptionId) external {
        ...
        BENEFICIARY_ADDRESS.transfer(sub.amount);

        emit SubscriptionExecuted(_subscriptionId, BENEFICIARY_ADDRESS, sub.amount);
    }
